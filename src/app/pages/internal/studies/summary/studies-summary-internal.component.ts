...
@Component({
    selector: 'app-studies-summary-internal',
    templateUrl: './studies-summary-internal.component.html'
})
export class StudiesSummaryInternalComponent implements OnInit {
