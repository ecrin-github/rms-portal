...
@Component({
    selector: 'app-objects-summary-external',
    templateUrl: './objects-summary-external.component.html'
})
export class ObjectsSummaryExternalComponent implements OnInit {
